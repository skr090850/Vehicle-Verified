...
class _DentingPaintingScreenState extends State<DentingPaintingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Denting & Painting', style: TextStyle(color: Colors.white)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(title: 'What We Offer', content: _buildInclusionsCard(_includedServices)),
            const SizedBox(height: 24),
            _buildSection(
      ...
      bottomNavigationBar: _buildBookingButtonWidget(context, 'Get Cost Estimate'),
    );
  }
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: selectedDate == null ? 'Select a date' : DateFormat('dd MMM,<x_bin_880>').format(selectedDate),
