...
class _DeepCleaningScreenState extends State<DeepCleaningScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Deep Cleaning Service', style: TextStyle(color: Colors.white)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(title: 'Our Cleaning Process', content: _buildInclusionsCard(_includedServices)),
            const SizedBox(height: 24),
            _buildSection(title: 'Schedule Your Service', content: _buildSchedulingForm()),
          ],
        ),
      ),
      bottomNavigationBar: _buildBookingButtonWidget(context, 'Book Cleaning Slot'),
    );
  }
